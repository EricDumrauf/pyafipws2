...
class TrazaRenpre(BaseWS):
    ...
    def __analizar_errores(self, ret):
        ...
        self.Errores = [
            "%s: %s" % (it.get("_c_error", ""), it.get("_d_error", ""))
    ...
    def SaveTransacciones(
        ...
        n_serie=None,
        n_lote=None,
        doc_despacho_plaza=None,
        djai=None,
        n_cert_impo_expo=None,
        id_tipo_documento=None,
        n_documento=None,
        m_calidad_analitica=None,
        m_entrega_parcial=None,
        doc_permiso_embarque=None,
        gln_transportista=None,
        operacion_excento_djai=None,
        control_duplicidad=None,
    ):
        ...
        params = {
            ...
            "djai": djai,
            "n_cert_impo_expo": n_cert_impo_expo,

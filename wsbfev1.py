...
class WSBFEv1(BaseWS):
    ...
    def CrearFactura(
        ...
        **kwargs
        ...
        fact = {
            ...
            "imp_perc": imp_perc,
            "imp_perc_mun": imp_perc_mun,
            "imp_iibb": imp_iibb,
            "imp_internos": imp_internos,
            "imp_moneda_id": imp_moneda_id,
            "imp_moneda_ctz": imp_moneda_ctz,
    ...
    def AgregarItem(
        self, ncm, sec, ds, qty, umed, precio, bonif, iva_id, imp_total, **kwargs
    ):
    ...
    def Authorize(self, id):
        ...
        ret = self.client.BFEAuthorize(
            ...
            Cmp={
                ...
                "Imp_tot_conc": f["imp_tot_conc"],
                "Imp_op_ex": f["imp_op_ex"],
                "Imp_neto": f["imp_neto"],
                "Impto_liq": f["impto_liq"],
                "Impto_liq_rni": f["impto_liq_rni"],
                "Imp_perc": f["imp_perc"],
                "Imp_perc_mun": f["imp_perc_mun"],
                "Imp_iibb": f["imp_iibb"],
    ...
    def GetCMP(self, tipo_cbte, punto_vta, cbte_nro):
        ...
        ret = self.client.BFEGetCMP(
            Auth={"Token": self.Token, "Sign": self.Sign, "Cuit": self.Cuit},
            Cmp={"Tipo_cbte": tipo_cbte, "Punto_vta": punto_vta, "Cbte_nro": cbte_nro},
        )

...
class WSCT(BaseWS):
    ...
    def AutorizarComprobante(self):
        ...
        fact = {
            ...
            "codigoPais": f["cod_pais"],
            "domicilioReceptor": f["domicilio"],
            ...
            "arrayDatosAdicionales": [
                {"tipoDatoAdicional": ta} for ta in f["adicionales"]
            ]
            or None,
            "arrayFormasPago": [
                {
    ...
    def ConsultarTiposIVA(self):
        ...
        return [
            "%(codigo)s: %(descripcion)s" % p["codigoDescripcionString"]
    ...
    def ConsultarTiposDatosAdicionales(self, sep="|"):
        ...
        for u in result["arrayTiposDatosAdicionales"]:
            ...
            ret.append(r)
        return (
            [("\t%(codigo)s\t%(ds)s\t" % it).replace("\t", sep) for it in ret]
            if sep
            else ret
        )
...
def main():
    ...
    if "--prueba" in sys.argv:
        ...
        try:
            ...
            imp_iva = 21.00
            imp_subtotal = 121.00
            wsct.AgregarItem(tipo, cod_tur, codigo, ds, iva_id, imp_iva, imp_subtotal)
            ...
            if cae:
                ...
                assert (
                    wsct.ObtenerTagXml("arrayItems", 0, "item", "unidadesMtx")
                    == "123456"
                )

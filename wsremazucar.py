...
WSDL = [
    "https://serviciosjava.afip.gob.ar/wsremazucar/RemAzucarService?wsdl",
...
class WSRemAzucar(BaseWS):
    ...
    def CrearRemito(
        ...
        cuit_titular_mercaderia=None,
        cuit_autorizado_retirar=None,
        ...
        **kwargs
        ...
        self.remito = {
            ...
            "tipoTitularMercaderia": tipo_titular_mercaderia,
    ...
    try:
        ...
        if "--ult" in sys.argv:
            ...
            if wsremazucar.Excepcion:
                ...
                if DEBUG:
                    print(wsremazucar.Traceback, file=sys.stderr)
        ...
        if "--consultar" in sys.argv:
            ...
            try:
                ...
                ok = wsremazucar.ConsultarRemito(
